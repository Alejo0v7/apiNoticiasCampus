...
Route::post('/resgistro', [UsuarioController::class, 'registro']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('publicacionesCategoria/{categoriaId}', [PublicacionController::class, 'publicacionesPorCategoria']);
